...
const STATICS = {
  //@@viewOn:statics
  displayName: Config.TAG + "CategoryListBoxCollection",
  nestingLevel: "boxCollection",
  //@@viewOff:statics
};

export const CategoryListBoxCollection = createVisualComponent({
  ...STATICS,
...
export default UU5.Common.Component.memo(CategoryListBoxCollection);
